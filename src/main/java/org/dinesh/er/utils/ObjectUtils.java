  ...
  public static Object getEnumConstantByName(Class klass, String name) {
    ...
    for (int ix = 0; ix < c.length; ix++)
      if (c[ix].toString().equals(name))
        return c[ix];
    throw new ErException("No such " + klass + ": '" + name + "'");
  }
 ...
 * @throws Exception 
  ...
  public static void setBeanProperty(Object object, String prop, String value,
    ...
    try {
      ...
      if (!found)
        throw new ErException("Couldn't find method '" + prop + "' in " +
                                      "class " + object.getClass());
    } catch (IllegalArgumentException e) {
      throw new ErException("Couldn't set bean property " + prop +
  ...
  private static Object convertToType(String value, Class type,
    ...
    if (type == String.class)
      ...
      if (value.length() != 1)
        throw new ErException("String '" + value + "' is not a character");
