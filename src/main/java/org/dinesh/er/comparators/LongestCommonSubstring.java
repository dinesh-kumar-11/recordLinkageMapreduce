...
package org.dinesh.er.comparators;
...
public class LongestCommonSubstring implements Comparator {
  ...
  private double compare_(String s1, String s2) {
    ...
    double returnVal=0;
    try {
    	returnVal = formula.compute(removed, shortlen, longlen);
	} catch (Exception e) {
  ...
  public enum Formula {    
    ...
    public double compute(int removed, int shortlen, int longlen) throws Exception {
      throw new ErException("Unknown formula: " + this);
    }
  }
}