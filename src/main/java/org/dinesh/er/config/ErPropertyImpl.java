 ...
 */
public class ErPropertyImpl implements ErProperty {
	private String name;
	private boolean id;
	...
	public ErPropertyImpl(String name) {
		this.name = name;
		this.id = true;
		this.analyzed = false;
	...
	public ErPropertyImpl(String name, Comparator comparator, double low,
			double high) {
		this.name = name;
		this.id = false;
	...
	/**
	 * Sets the comparator used for this property. Note that changing this while
	 * Duke is processing may have unpredictable consequences.
	 */
	...
	/**
	 * Sets the high probability used for this property. Note that changing this
	 * while Duke is processing may have unpredictable consequences.
	 */
	...
	/**
	 * Sets the low probability used for this property. Note that changing this
	 * while Duke is processing may have unpredictable consequences.
	 */
	...
	public ErProperty copy() {
		if (id)
			return new ErPropertyImpl(name);

		ErPropertyImpl p = new ErPropertyImpl(name, comparator, low, high);
	...
	public String toString() {
		return "ErPropertyImpl [name=" + name + ", id=" + id + ", analyzed="
				+ analyzed + ", ignore=" + ignore + ", comparator="
				+ comparator + ", high=" + high + ", low=" + low + ", lookup="
				+ lookup + "]";
	}
